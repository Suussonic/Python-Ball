...
# Couleur initiale de la balle
couleur_balle = couleur_aleatoire()
...
while running:
    ...
    if distance_prevue + rayon_balle >= rayon_cercle:
        ...
        # Changer la couleur de la balle à chaque collision
        couleur_balle = couleur_aleatoire()
    ...
    pygame.draw.circle(fenetre, couleur_balle, (int(position_balle_x), int(position_balle_y)), rayon_balle)
